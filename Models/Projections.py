...
def Pth_to_uK(rs, thetas, AngDist, beam_data, beam_ells, resp_data, resp_ells, XH, **kwargs):
...
def Pth_to_y(rs, thetas, AngDist, beam_data, beam_ells, XH, **kwargs):
...
def rho_to_uK(rs, thetas, AngDist, beam_data, beam_ells, XH, v_rms, T_CMB, **kwargs):
