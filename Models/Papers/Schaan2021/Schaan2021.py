...
class Studies(BaseStudy):  # ui.adsabs.harvard.edu/abs/2021PhRvD.103f3513S
    subs = {
    ...
    def __init__(self, inputsdict={}, **inputvars):
        ...
        for k, v in row.items():
            ...
            if k == 'MhMean' and v is not None: v = v *u.Msun
            setattr(self, k, v)


class TargetData(BaseTargetData, Studies.Schaan2021):  # ACT DR5 maps stacked on SDSS BOSS DR10
...
class Measurements(BaseMeasurement, Studies.Schaan2021):  # ACT DR5 maps stacked on SDSS BOSS DR10 (Schaan+ 2021, arxiv.org/abs/2009.05557)
    path = f"{datapath}/Schaan2021"  # path to data, shared by author
    subs = {
        'sample': ['cmass', 'lowz'],
...
class Plots(BasePlots):  # ui.adsabs.harvard.edu/abs/2021PhRvD.103f3513S
